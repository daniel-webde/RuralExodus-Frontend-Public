  ...
  return (
    <nav className=" bg-gray-900">
      <img
        src="logo.png"
        alt="logo"
        className="absolute hidden md:flex w-24 h-24 ml-20"
      />
      <div className="md:ml-48 md:pt-3 py-3 md:py-0">
        <div className="flex justify-between w-full">
          ...
          >
            <button>
              {open ? (
                <FaAlignRight className="text-white size-5 mr-5 sm:hidden duration-500 z-50" />
              ) : (
                <FaAlignJustify className="text-white size-5 mr-5 sm:hidden duration-500" />
              )}
            </button>
          </div>
        </div>
        <div className="hidden sm:flex sm:justify-between">
          <ul className="uppercase font-montreal font-bold text-gray-100 text-sm flex">
            <li className="px-3 py-2 hover:text-gray-300">
              <a href="">Who we are</a>
            </li>
            <li className="px-3 py-2 hover:text-gray-300">
              <a href="">What we do</a>
      ...
      {/* Mobile Nav */}
      <div
        className={`sm:hidden font-montreal absolute w-full h-full bg-gray-900 pl-3 duration-500 border-t-2 border-red-400 ${
      ...
      >
        ...
        <img
          src="logo.png"
          alt="logo"
          className="w-20 h-20 mt-3 rounded mx-auto"
        />
        <ul className="font-semibold text-gray-100 text-lg text-center flex flex-col gap-5 pt-2">
        ...
        <p className="text-sm font-montreal font-bold text-gray-400 pt-9 text-center">
