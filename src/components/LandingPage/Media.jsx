  ...
  return (
    <>
      <div className="grid sm:grid-cols-3 font-montreal px-6 py-8 sm:py-12">
        ...
        >
          <h2
            className={
              isHovered === 0
                ? "text-red-600 text-xl font-bold pb-2"
      ...
      <div className="sm:hidden">
        ...
        <Link
          to="/donate"
          className="bg-red-600 text-red-200 font-extrabold text-lg py-2 rounded tracking-wider flex justify-center mx-32 shadow-lg shadow-gray-500"
        >
          DONATE
        </Link>
      ...
      {/* Media Content */}
      <div className="py-7">
        <h2 className="text-center font-montreal text-4xl font-semibold">
          Media
        </h2>
